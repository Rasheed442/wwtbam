...
function ViewGamesDetailsPartners({ closegame }) {
  const [check, setCheck] = useState(false);
  return (
    <NewGame>
      <div className="new" onClick={() => closegame(false)}>
        <p>
      ...
      <div className="white">
        ...
        <div className="labelinput">
          <LabelinputLayout
            inputstyle={{ width: "50%" }}
            label="Question"
            placeholder="who's the president of Nigeria"
          />
...
export default ViewGamesDetailsPartners;
